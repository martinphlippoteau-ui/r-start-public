 ...
 * (EngineGain, StrategySelect, StrategyTiming ; EngineRent garde ses fenêtres écrites en dur, il
 * n'a pas changé le 16/09/2026).
 *
 * UN IMMEUBLE, C'EST UN CADRE ET UNE GRILLE DE FENÊTRES : c'est ce qui le fait lire comme un immeuble
