 ...
 *
 * ATTENTION : un `import.meta.glob` paresseux ne rend PAS les images inutilisées gratuites. Il crée un import dynamique par fichier trouvé, et comme
 ...
 * (audit du 14/09/2026).
 *
 * D'où la règle : `src/assets/images` ne contient QUE ce que media.ts cite. Une image qui n'est plus
 * citée quitte le dossier dans le même geste ; l'historique git la garde. (La réserve de curation,
 * `src/assets/vivier`, hors du motif, a été supprimée le 22/09/2026 : le site n'affiche plus de photo.)
 */
