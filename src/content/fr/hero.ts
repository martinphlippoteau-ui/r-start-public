...
export const hero = {
  ...
  /* Sous le bandeau Trustpilot (24/09/2026, formulation et emplacement de Martin, choisis
     parmi cinq variantes essayées). CORUM L'Épargne DISTRIBUE R Start ; CORUM Asset
