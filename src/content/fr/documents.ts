...
/**
 * Documents exclus de la publication. « statuts » : le PDF fourni (public/documents/r-start-statuts.pdf,
 * 61 440 octets) est tronqué et illisible ; le retirer de cette liste dès que CORUM a livré le fichier
 * complet. Les statuts restent disponibles sur www.corum.fr (note « documents-corum »).
 */
const EXCLUDED_KEYS: readonly string[] = ['statuts'];
