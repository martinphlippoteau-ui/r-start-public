 ...
 * « @/ » n'existe pas. Les pages le lisent par src/content/fr/documentation.ts (`isDocumentPublished`).
 *
 ...
 *
 * Désormais : une clé listée ici n'est ni liée (documentation.ts), ni copiée
 ...
 *
 * Les raisons de chaque mise en attente sont écrites dans documentation.ts, au-dessus d'`isDocumentPublished`.
