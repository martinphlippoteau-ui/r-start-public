/**
 * SIMULATEUR : L'ADRESSE DE « COMMENCER MA SOUSCRIPTION » (demande de Martin). Le bouton de l'écran
 * de résultat mène au tunnel de souscription avec les choix du visiteur en paramètres, pour que sa
 * première étape arrive préremplie. Fonction pure : ./page.ts l'appelle à chaque résultat,
