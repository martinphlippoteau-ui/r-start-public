...
export const sections: Record<SectionKey, SectionMeta> = {
  ...
  fees: { id: 'frais', label: 'Frais', order: 3, inNav: true },
  strategy: { id: 'strategie', label: 'Stratégie', order: 4, inNav: true },
  income: { id: 'revenus', label: 'Revenus', order: 5, inNav: false },
  subscribe: { id: 'souscrire', label: 'Souscription', order: 6, inNav: true },
  corum: { id: 'corum', label: 'Confiance', order: 7, inNav: true },
  risks: { id: 'risques', label: 'Risques', order: 8, inNav: true },
  documents: { id: 'documents', label: 'Documents', order: 9, inNav: false },
  faq: { id: 'faq', label: 'FAQ', order: 10, inNav: true },
